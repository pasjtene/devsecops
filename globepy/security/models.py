...
class SecurityManagementRequirement(models.Model):
    class RequirementList(models.TextChoices):
        ...
        ISO27001_322 = ("ISO27001_322", _("3-2-2: Identify Vulnerabilities (e.g., weak passwords, outdated software), conduct vulnerability assessment, establish a vulnerability management team for larger organizations"))
